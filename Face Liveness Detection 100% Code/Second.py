...
def verify():
    global count  #variable outside of the current scope
    global Window
...
label1=Label(Window,text="Verification Screen",relief="solid",font=("arial",20,"bold"),fg='forestgreen').pack(fill=BOTH)
a=StringVar()
...
ver = Button(Window, text="Verify",relief="raised", bg='forestgreen', font=("arial", 25, "bold"), fg='white',command=verify).place(x=350,y=180)
Window.mainloop()