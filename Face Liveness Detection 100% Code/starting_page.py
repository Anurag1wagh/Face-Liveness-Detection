...
label_l1 = tk.Label(root, text="!!!___Face Liveness Detection___!!!",font=("Times New Roman", 35, 'bold'),
                    background="black", fg="white", width=30, height=1)
label_l1.place(x=300, y=100)
...
button2 = tk.Button(root, text="Check Authentication",command=main,width=20, height=1,font=('times', 20, ' bold '), bg="lightblue", fg="black")
