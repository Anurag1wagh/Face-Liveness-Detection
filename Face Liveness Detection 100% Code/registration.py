...
cursor.execute("CREATE TABLE IF NOT EXISTS registration"
               "(Fullname TEXT, Location TEXT, username TEXT, Email TEXT, Phoneno TEXT,Gender TEXT,age TEXT , password TEXT)")
db.commit()
...
def insert():
    ...
    if (fname.isdigit() or (fname == "")):
        ...
        with conn:
            cursor = conn.cursor()
            cursor.execute(
                'INSERT INTO registration(Fullname, stmt, username, Email, Phoneno, Gender, age , password) VALUES(?,?,?,?,?,?,?,?)',
...
l3 = tk.Label(window, text="Location :", width=12, font=("Times new roman", 15, "bold"), bg="snow")
